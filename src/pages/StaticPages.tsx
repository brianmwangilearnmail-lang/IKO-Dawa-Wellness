        ...
        <div className="space-y-12 h-full flex flex-col justify-center">
          <div>
            ...
            <p className="text-lg text-slate-500 leading-relaxed max-w-md">
              Whether you're seeking guidance on protocol or tracking an order, our specialists are standing by.
            </p>
          </div>

          <div className="grid sm:grid-cols-2 gap-12 pt-8">
            <div className="space-y-3">
              <p className="text-[10px] uppercase font-black tracking-widest text-slate-400">Direct Inquiries</p>
              <a href="mailto:info@ikodawa.com" className="text-lg font-serif text-slate-900 border-b border-transparent hover:border-emerald-500 transition-colors block italic">
                info@ikodawa.com
              </a>
            </div>
            <div className="space-y-3">
              <p className="text-[10px] uppercase font-black tracking-widest text-slate-400">Call Us</p>
              <a href="tel:+254714279143" className="text-lg font-serif text-slate-900 border-b border-transparent hover:border-emerald-500 transition-colors block italic">
                +254 714 279143
              </a>
            </div>
          </div>
        ...
        {popup.show && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-6">
            ...
            <motion.div 
              ...
              className="relative w-full max-w-sm bg-white rounded-[2.5rem] p-10 shadow-2xl flex flex-col items-center text-center border border-slate-100"
            >
              ...
              <h3 className="font-serif text-3xl text-slate-950 mb-4 italic">
                {popup.type === 'success' ? 'Received' : 'Connection Error'}
              </h3>
              ...
              <button 
                onClick={() => setPopup({ ...popup, show: false })}
                className="w-full py-4 bg-slate-950 text-white rounded-2xl font-bold text-xs uppercase tracking-widest hover:bg-emerald-600 transition-colors shadow-lg"
              >
                Dismiss
              </button>
            </motion.div>
      ...
      <div className="relative z-20 py-24 md:py-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto bg-[var(--bg)]">
        <div className="flex flex-col md:flex-row items-baseline justify-between mb-24 gap-8">
          <div className="max-w-2xl">
            <p className="text-[10px] uppercase tracking-[0.4em] text-emerald-600 font-bold mb-4">Precision Research</p>
            <h1 className="text-5xl md:text-8xl font-serif text-slate-950 leading-none">
              Rigorous <span className="italic text-emerald-800">Proofs</span>
            </h1>
          </div>
          <p className="text-base md:text-lg text-slate-500 max-w-sm leading-relaxed">
            Every IKO DAWA formulation begins in the lab, validated by third-party clinical data and molecular bioavailability screening.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 md:gap-24 items-center mb-32">
          ...
          <div className="space-y-12 order-1 lg:order-2">
            <div className="space-y-6">
              <h2 className="text-3xl md:text-5xl font-serif text-slate-900 leading-tight italic">Documented Bioavailability</h2>
              <p className="text-slate-600 leading-relaxed text-lg">
                We believe in transparency. We use clinical dosages proven in human trials, ensuring nutrient delivery is targeted and measurable.
              </p>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-8">
              <div className="p-6 bg-white border border-slate-100 rounded-3xl shadow-sm hover:shadow-xl transition-all">
                ...
                <h4 className="font-serif text-xl mb-2 italic">cGMP Verified</h4>
                <p className="text-slate-500 text-xs leading-relaxed">Manufactured in elite facilities under stringent environmental controls.</p>
              </div>
              <div className="p-6 bg-white border border-slate-100 rounded-3xl shadow-sm hover:shadow-xl transition-all">
                <div className="w-10 h-10 bg-blue-50 rounded-xl flex items-center justify-center text-blue-600 mb-4">
                  <CheckCircle2 className="w-5 h-5" />
                </div>
                <h4 className="font-serif text-xl mb-2 italic">Zero Contaminants</h4>
                <p className="text-slate-500 text-xs leading-relaxed">Systematic screening for heavy metals, pesticides, and residual solvents.</p>
              </div>
            </div>
          </div>
        </div>
    ...
    return (
      <div className="relative z-20 py-24 md:py-32 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto bg-[var(--bg)]">
        <div className="mb-16 text-center">
          <p className="text-[10px] uppercase tracking-[0.5em] text-emerald-600 font-bold mb-6">Trust Framework</p>
          <h1 className="text-5xl md:text-7xl font-serif text-slate-950 leading-none mb-4 italic">
            Privacy Policy
          </h1>
          <p className="text-slate-400 font-black uppercase text-[9px] tracking-widest mt-8">Revised: April 2026</p>
        </div>
        ...
        <div className="bg-white border border-slate-100 rounded-[3rem] p-10 md:p-16 space-y-12 text-slate-600 leading-relaxed shadow-2xl relative overflow-hidden">
          ...
          <section className="relative z-10">
            <h2 className="font-serif text-2xl text-slate-950 mb-4 italic">01. Data Governance</h2>
            <p className="border-l-2 border-emerald-500/20 pl-6">We prioritize the security of your biological and transactional data. Information collected during checkout is for the sole intention of order fulfillment and clinical updates.</p>
          </section>
          
          <section className="relative z-10">
            <h2 className="font-serif text-2xl text-slate-950 mb-4 italic">02. Ethical Use</h2>
            <p className="border-l-2 border-emerald-500/20 pl-6">We do not engage in the monetization of customer browsing habits or purchase histories. Your data is your property.</p>
          </section>
  
          <section className="relative z-10">
            <h2 className="font-serif text-2xl text-slate-950 mb-4 italic">03. Security Integrity</h2>
            <p className="border-l-2 border-emerald-500/20 pl-6">Utilizing PCI-compliant encryption pipelines and cold-storage strategies, we ensure your personal identifier information remains isolated from public vectors.</p>
          </section>
        </div>
      </div>
    );
